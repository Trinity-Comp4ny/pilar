-- Restaura portal_get_projeto_full sobrescrita pelo stub de debug 20260507670000.
-- DROP + CREATE garante substituição limpa (evita falha silenciosa de overloads).

DROP FUNCTION IF EXISTS "public"."portal_get_projeto_full"(uuid, text);

CREATE FUNCTION "public"."portal_get_projeto_full"(
  "p_projeto_id" uuid,
  "p_token"      text
)
RETURNS json
