...
CREATE INDEX IF NOT EXISTS idx_receitas_empresa_status_active
...
CREATE INDEX IF NOT EXISTS idx_despesas_empresa_status_active
...
CREATE INDEX IF NOT EXISTS idx_projetos_empresa_status_active
  ON public.projetos(empresa_id, status)
  WHERE deleted_at IS NULL;

-- Marcos faturamento: queries por projeto_id + status, excluindo soft-deleted
CREATE INDEX IF NOT EXISTS idx_marcos_projeto_status_active
