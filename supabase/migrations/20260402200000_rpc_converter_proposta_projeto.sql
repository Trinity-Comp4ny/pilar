-- Sprint 1.2: RPC para converter proposta aceita em projeto completo
-- Cria projeto + projeto_orcamento_fases a partir da proposta e proposta_disciplinas
...
BEGIN
  ...
  -- Gerar codigo do projeto baseado no codigo da proposta ou sequencial
