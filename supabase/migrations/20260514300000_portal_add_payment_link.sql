-- Recria ambos os overloads de get_cliente_projeto_detail incluindo campos
-- de pagamento Asaas nas receitas (asaas_payment_url, asaas_billing_type).
-- DROP + CREATE é obrigatório para evitar conflito silencioso de overloads.
    ...
    'receitas',                COALESCE(
      (SELECT json_agg(
         json_build_object(
           ...
           'status',              r.status,
           'asaas_payment_url',   r.asaas_payment_url,
           'asaas_billing_type',  r.asaas_billing_type
