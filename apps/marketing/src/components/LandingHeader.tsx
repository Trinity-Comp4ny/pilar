...
export function LandingHeader() {
  ...
  return (
    <header className="fixed top-0 inset-x-0 z-50 bg-paper/90 backdrop-blur-md border-b border-paper-border">
      ...
      <div className="container mx-auto px-6 md:px-10 h-16 flex md:grid md:grid-cols-[1fr_auto_1fr] items-center gap-6">
        ...
        >
          ...
          />
          <span className="text-xl font-medium tracking-tight text-ink-soft">Pilar</span>
        </Link>
        ...
        <button
          type="button"
          className="md:hidden p-2 text-ink-soft ml-auto"
      ...
      {mobileMenuOpen && (
        <div
          ...
          className="md:hidden absolute top-full left-0 right-0 bg-paper border-b border-paper-border p-6 flex flex-col gap-1 shadow-xl"
        >
