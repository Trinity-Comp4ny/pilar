...
> O Pilar conecta proposta, projeto, cobrança e financeiro num fluxo só, e mostra ao dono se cada projeto está dando lucro **antes** de terminar.
...
## Provas / credibilidade

- `[A DEFINIR]` design partner (escritório real) — caso com número.
- `[A DEFINIR]` métrica de tração (escritórios ativos, projetos geridos).
- Histórico como ativo: valor médio/m², taxa de aprovação de proposta. Ref: `research/INSIGHTS.md` #4.
