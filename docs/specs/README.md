...
| [075](./075-motor-de-tokens-enforcement-e-superficies.md)          | Motor de tokens, Fase 2: cota mensal por plano, `gate_tokens` (concessão de ciclo idempotente), bloqueio 402, chip de saldo em tokens, markdown no chat, header padrão | Em implementação |
