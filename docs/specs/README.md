...
| [074](./074-motor-de-tokens-ledger-saldo-e-debito.md)              | Motor de tokens, fundação (Fases 0-1 do MOTOR_DE_TOKENS.md): `ai_token_ledger` fonte única, saldo por empresa, débito idempotente, shadow mode | Draft |
