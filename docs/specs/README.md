...
| [064](./064-fila-cotacoes-pendentes-cross-obra.md)                  | Fila de cotações pendentes cruzando todas as obras, seção na página /obras existente, sem rota nova (estende 018)                            | Draft            |
