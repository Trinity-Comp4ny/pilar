...
| [067](./067-guardiao-de-escopo-alerta.md)                           | Guardião de escopo (FIN-5): alerta quando despesas do projeto passam o escopo aprovado sem aditivo em análise, via `gerar_alertas_ambient()` | Em implementação |
