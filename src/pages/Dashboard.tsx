...
import { stats, chartDataMensal } from "./financeiro/data/mockData";
  ...
  return (
        ...
        <PageHeader 
          ...
          children={
            <div className="flex items-center gap-2">
              ...
              <Button className="text-sm vrz-button-primary" onClick={() => navigate('/financeiro')}>
                Nova Transação
              </Button>
            </div>
          }
    ...
    >
      <div className="space-y-6 w-full max-w-none">
        ...
        <Card className="vrz-card w-full border-none shadow-sm">
          <CardHeader>
