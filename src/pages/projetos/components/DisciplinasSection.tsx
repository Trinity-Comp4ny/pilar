                        ...
                        <div className="grid grid-cols-3 gap-1.5">
                          <div className="space-y-0.5">
                            ...
                            <Input
                              ...
                              onChange={(e) => onNewFormRespChange({ ...newFormResp, data_inicio: e.target.value })}
                            />
                          </div>
                          <div className="space-y-0.5">
                            <Label className="text-[9px] text-muted-foreground">Previsão</Label>
                            <Input
                              ...
                              onChange={(e) => onNewFormRespChange({ ...newFormResp, data_previsao: e.target.value })}
                            />
                          </div>
                          <div className="space-y-0.5">
                            <Label className="text-[9px] text-muted-foreground">Final</Label>
                            <Input
                              ...
                              onChange={(e) => onNewFormRespChange({ ...newFormResp, data_final: e.target.value })}
                            />
                          </div>
                        </div>
