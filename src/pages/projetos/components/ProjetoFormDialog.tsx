                      ...
                      <div className="flex items-center justify-between p-3">
                        ...
                        <div className="flex gap-1">
                          <Button
                            ...
                            variant="ghost"
                            size="sm"
                            onClick={() => handleOpenDisciplinaDetail(idx)}
                          ...
                          <Button
                            ...
                            variant="ghost"
                            size="sm"
                            onClick={() => removeProjetoDisciplina(idx)}
                                ...
                                <div className="flex items-center justify-between">
                                  ...
                                  {resps.length > 1 && (
                                    <Button
                                      ...
                                      onClick={() => removeResponsavelFromDisc(idx, rIdx)}
                                    >
                                      <Trash2 size={10} />
                                    </Button>
                                  )}
                                ...
                                <div className="grid grid-cols-3 gap-1.5">
                                  ...
                                  <div className="space-y-0.5">
                                    ...
                                    <Input
                                      ...
                                      onChange={(e) =>
                                        updateRespDatasInForm(idx, rIdx, "data_previsao", e.target.value)
                                      }
                                    />
                                  </div>
                                  <div className="space-y-0.5">
                          ...
                          {addingRespToFormDisc === idx ? (
                            <div className="bg-blue-50/50 rounded-lg p-2.5 border border-dashed border-blue-200 space-y-2">
                              <Select
                                ...
                                onValueChange={(v) => setNewFormResp((prev) => ({ ...prev, responsavel_id: v }))}
                              >
                              ...
                              <div className="grid grid-cols-3 gap-1.5">
                                <div className="space-y-0.5">
                                  ...
                                  <Input
                                    ...
                                    onChange={(e) =>
                                      setNewFormResp((prev) => ({ ...prev, data_inicio: e.target.value }))
                                    }
                                  />
                                </div>
                                <div className="space-y-0.5">
                                  ...
                                  <Input
                                    ...
                                    onChange={(e) =>
                                      setNewFormResp((prev) => ({ ...prev, data_previsao: e.target.value }))
                                    }
                                  />
                                </div>
                                <div className="space-y-0.5">
                                  ...
                                  <Input
                                    ...
                                    onChange={(e) =>
                                      setNewFormResp((prev) => ({ ...prev, data_final: e.target.value }))
                                    }
                                  />
                                </div>
                              </div>
                              <div className="flex gap-2">
                                <Button
                                  ...
                                  onClick={() => addResponsavelToDisc(idx)}
                                >
                                  Adicionar
                                </Button>
                                <Button
