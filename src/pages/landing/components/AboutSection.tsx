...
export function AboutSection() {
  const items = [
    { icon: <LayoutTemplate className="w-5 h-5" />, title: "Interface Intuitiva", desc: "Design limpo e pensado para a usabilidade diária." },
    { icon: <Building2 className="w-5 h-5" />, title: "Foco no Setor", desc: "Funcionalidades específicas para engenheiros e arquitetos." },
    { icon: <LineChart className="w-5 h-5" />, title: "Evolução Constante", desc: "Atualizações frequentes baseadas no feedback de clientes." },
  ];
